    ...
    <>
      <section className='search'>
        <div className='search__container'>
          ...
          <input autoFocus={ currentPage ? true : false } ref={ inputSearchRef }  className='search__input' onChange={ ({ target }) => setInputSearch( target.value ) } value={ inputSearch } placeholder={ currentPage ? 'Type your name' : 'Look for the contact'} type="text" />
        </div>
