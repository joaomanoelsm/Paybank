...
const Credit = () => {
  ...
  const switchSideOfArrow = (e) => {
    ...
    if (e.target.parentNode.classList.contains("animation"))
  ...
  return (
    <section id="credit-card">
      ...
      <div
        onClick={() => navigate("/Paybank/credit/add-card")}
        id="credit-card__add"
      >
        <img src={addIcon} alt="" />
        ...
        {cardsArray.map((cardStyle) => (
          <div key={cardStyle.id} className="credit-card__details">
            <div id="credit-card__summary" onClick={switchSideOfArrow}>
              ...
              <img
                ref={arrowRef}
                id="credit-card__arrow"
                src={arrowIcon}
                alt="Icone de direção"
              />
            </div>
            <div className="credit-card__data">
              <Card
                cardNumber={cardStyle.cardNumber}
                userName={cardStyle.userName}
